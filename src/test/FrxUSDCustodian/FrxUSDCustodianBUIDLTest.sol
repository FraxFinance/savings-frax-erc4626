...
contract FrxUSDCustodianBUIDLTest is FraxTest, Constants.Helper {
    FrxUSD public frxUSD = FrxUSD(0xCAcd6fd266aF91b8AeD52aCCc382b4e165586E29);
    IERC20 public BUIDL = IERC20(0x7712c34205737192402172409a8F7ccef8aA2AEc);
    ...
    function test_BUIDL_whitelist() public {
        ...
        vm.startPrank(whale);
        BUIDL.transfer(address(this), 1000e6);
        vm.stopPrank();
    }
    ...
    function test_deployment() public {
        ...
        assertEq(address(frxUSDCustodian.custodianTkn()), address(BUIDL), "custodianTkn should be set");
    ...
    function test_mint() public {
        ...
        BUIDL.approve(address(frxUSDCustodian), 102e18);
        ...
        uint256 balanceBUIDL = BUIDL.balanceOf(address(whale));
        ...
        uint256 amountIn = balanceBUIDL - BUIDL.balanceOf(address(whale));
        ...
        assertApproxEqAbs(BUIDL.balanceOf(address(frxUSDCustodian)), amountIn, 1, "custodian balance incorrect");
        vm.stopPrank();
    }
    ...
    function test_deposit() public {
        ...
        BUIDL.approve(address(frxUSDCustodian), 100e18);
    ...
    function test_redeem() public {
        ...
        uint256 amountOut = BUIDL.balanceOf(address(whale)) - balanceBUIDL;
    ...
    function test_withdraw() public {
        ...
        BUIDL.approve(address(frxUSDCustodian), 112e18);
        ...
        uint256 amountIn = balanceFrxUSD - frxUSD.balanceOf(address(whale));
        assertApproxEqAbs(amountOut, expectedOut, 1, "Amount out should be correct");
        assertApproxEqAbs(amountIn, expectedIn, 1e12, "Amount in should be correct");
    ...
    function test_mintCap() public {
        ...
        BUIDL.approve(address(frxUSDCustodian), 1_000_000e18);
    ...
    function test_withdrawCap() public {
        ...
        assertApproxEqAbs(
            maxWithdraw,
            BUIDL.balanceOf(address(frxUSDCustodian)),
            1,
    ...
    function test_ownerFunctionality() public {
        defaultSetup(BUIDL);
        whitelist(frxUSDCustodian.owner());
        address whale = 0xEd71aa0dA4fdBA512FfA398fcFf9db8C49A5Cf72;
        vm.startPrank(whale);
        ...
        vm.expectRevert(); // Revert when not owner
        frxUSDCustodian.recoverERC20(address(BUIDL), 1000e6);
        vm.stopPrank();
        ...
        uint256 balance = BUIDL.balanceOf(frxUSDCustodian.owner());
        frxUSDCustodian.recoverERC20(address(BUIDL), 1000e6);
        assertEq(BUIDL.balanceOf(frxUSDCustodian.owner()), balance + 1000e6, "ERC20 should be recovered");
        vm.stopPrank();
